...
export default function Setlist() {
  ...
  return (
    <div style={{ padding: isMobile ? '16px 14px' : '32px 40px' }}>
      ...
      {/* Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28, ...(isMobile && { paddingTop: 'env(safe-area-inset-top, 0px)' }) }}>
        <div>
          <h1 style={{ fontSize: isMobile ? 22 : 28, fontWeight: 700, margin: 0, letterSpacing: '-0.02em', background: 'linear-gradient(135deg, #ffffff 0%, rgba(255,255,255,0.75) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Setlists</h1>
